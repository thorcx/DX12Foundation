...
namespace StencilMirror
{
	...
	class StencilMirrorApp : public D3DApp
	{

	public:
		StencilMirrorApp(HINSTANCE hInstance);
		StencilMirrorApp(const StencilMirrorApp& rhs) = delete;
		StencilMirrorApp& operator=(const StencilMirrorApp& rhs) = delete;
		~StencilMirrorApp();
